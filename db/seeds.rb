...
pokemon.each do |creature|
  ...
  creature_attrs = {
    name: creature["name"],
    body: {"type"=>data["types"][0]["name"],"abilities"=> data["abilities"][0]["name"],
          "attack" => data["attack"], "defense" => data["defense"], "special_attack" => data["sp_atk"],
          "special_defense" => data["sp_def"], "speed" => data["speed"]}.to_s,
